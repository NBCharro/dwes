...
-- Base de datos: `world`
--
CREATE DATABASE IF NOT EXISTS `world` DEFAULT CHARACTER SET latin1 COLLATE latin1_spanish_ci;
USE `world`;
...
CREATE TABLE IF NOT EXISTS `city` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=4080 ;
